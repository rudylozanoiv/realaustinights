...
export function HeroSkylineLogo({ onSignUpClick: _onSignUpClick }: HeroSkylineLogoProps) {
  return (
    <section
      ...
      className="relative isolate overflow-hidden border-b border-white/10 bg-[linear-gradient(180deg,#070509_0%,#0a0610_100%)] shadow-[0_30px_90px_rgba(0,0,0,0.4)]"
    >
      ...
      <div className="relative mx-auto w-full max-w-[1400px] px-3 pb-2 pt-2 md:px-5 lg:px-8">
        <div className="mx-auto w-full max-w-[1280px] overflow-hidden rounded-b-[28px] border-x border-b border-white/10 shadow-[0_24px_64px_rgba(0,0,0,0.42)]">
          <div className="relative aspect-[1280/282] w-full">
            <Image
              src="/assets/goldmaster-hero-crop.png"
