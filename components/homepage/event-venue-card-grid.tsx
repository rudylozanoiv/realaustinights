      ...
      {items.map((item) => (
        ...
        >
          <Link
            ...
            className="block focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-pink/70"
          >
            <article>
          ...
          {item.websiteUrl ? (
            <a
              ...
              className="relative z-10 mt-auto flex items-center justify-center gap-1 border-t border-white/8 px-4 py-2.5 text-[11px] font-semibold text-white/70 transition hover:bg-white/5 hover:text-pink focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-pink/70"
            >
              Visit site ↗
            </a>
          ) : null}
